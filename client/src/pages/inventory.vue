...
export default {
    ...
    mounted() {
        ...
        axios
            .get('/get-all-by-catalog-type?category=inventory')
            .then(response => {
...
<template>
    ...
    <div class="flex" style="display: flex; align-items: center;">
        ...
        <h3 v-if="selected_type == 'roller_skates'" class="h3-catalog-title" style="padding: 0 !important;">Роликовые коньки</h3>
            ...
            <router-link tag="li" class="card-item" :class="{ card_item_full: isFull }" v-for="item in filteredItems"
                ...
                <ul class="mini-card">
                    ...
                    <li class="card-icons">
                        ...
                        <span class="rating-value" v-else-if="item.color == 'grey'">
                            серый
                        </span>
                    </li>
                    <li class="card-icons">
